...
public class KlijentNit extends Thread {
   ...
   @Override
    public void run() {
        ...
        System.out.println("Nit klijent je zavrsila sa radom!");
    }
            ...
            try {
                ...
                switch(ct.getOperacija()){
                    ...
                    case Konstante.VRATI_STAVKE_ARANZMANA:
                            ...
                            List<OpstiDomenskiObjekat> stavke = Kontroler.getInstance().getStavkeAranzmana((Aranzman) ct.getParametar());
                            st.setUspesnost(Konstante.USPEH);
                            st.setPodaci(stavke);
